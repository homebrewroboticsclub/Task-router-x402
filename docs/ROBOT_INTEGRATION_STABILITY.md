...
| **Session grant** | `GET /api/robots/{robotId}/teleop/session-grant?helpRequestId=` | Same robot secret. Response fields **`teleopGrantPayload`**, **`teleopGrantSignature`**, error codes **`grant_not_ready`**, etc. |
